void DiaUpdateJQ3_3D(long long* SpinSystem,double* BondNOsystem,long long* Hoperator\
          ,double &Beta,long long &HNO,long long &Size,long long &SpinNO,long long &SingleSpinNO\
          ,long long &BondNO,long long &HoperatorNO,long long* BondNORecord,long long &XSize,long long &YSize,long long &ZSize)
{
   ...
   for(LoopNumA=0;LoopNumA <HoperatorNO*7;LoopNumA=LoopNumA+7)
    {
        ...
        if(Hoperator[LoopNumA]==-1)//該Hoperator 為空
        {
            ...
            if (BondNumber<(long long)(ZSize*SingleSpinNO*3))//J Bond
            {
