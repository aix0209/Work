void DiaUpdateJQ3_Honeycomb_Spin1(long long* SpinSystem,double* BondNOsystem,long long* Hoperator\
          ,double &Beta,long long &HNO,long long &Size,long long &SpinNO,long long &BondNO,long long &HoperatorNO,long long* BondNORecord\
          ,long long &XSize,long long &YSize)
{
   ...
   for(LoopNumA=0;LoopNumA <HoperatorNO*7;LoopNumA=LoopNumA+7)
    {
        ...
        if(Hoperator[LoopNumA]==-1)//該Hoperator 為空
        {
           ...
           BondNumberIndex=BondNumber*7;
            ...
            if (BondNumber<(long long)(SpinNO*1.5))//J Bond
            {
                ...
                if(genrand64_real2()*(double)(HoperatorNO-HNO)*2<(double)((BondNO)*(BondNOsystem[BondNumber*2+1]*Beta)))
                {
                   ...
                   {
                       if((long long)SpinSystem[BondNORecord[BondNumberIndex+2]*3+1]==(long long)SpinSystem[BondNORecord[BondNumberIndex+1]*3+1]*(-1))
                       {
                   ...
                   {
                       if((long long)SpinSystem[BondNORecord[BondNumberIndex+2]*3+1]==(long long)SpinSystem[BondNORecord[BondNumberIndex+1]*3+1])
                       {
            ...
            else//Q3 Bond
            {
                ...
                if(genrand64_real2()*(double)(HoperatorNO-HNO)*8<(double)((BondNO)*(BondNOsystem[BondNumber*2+1]*Beta)) )
                {
                    if(BondNORecord[BondNumberIndex]==-1)
                    {
                        //=BondNumber-(long long)(BondNO*0.5);
                       ...
                       //printf("LeftBond=%d RightBond=%d \n",LeftBond,RightBond);
                        ...
                        //printf("%d  Table LeftSpin=%d  RightSpin=%d  LeftSpin2=%d  RightSpin2=%d LeftSpin3=%d  RightSpin3=%d  \n",BondNumber,BondNORecord[BondNumberIndex+1],BondNORecord[BondNumberIndex+2],BondNORecord[BondNumberIndex+3],BondNORecord[BondNumberIndex+4],BondNORecord[BondNumberIndex+5],BondNORecord[BondNumberIndex+6]);
                       
                       
                       if((long long)SpinSystem[BondNORecord[BondNumberIndex+1]*3+1]==(long long)SpinSystem[BondNORecord[BondNumberIndex+2]*3+1]*(-1) and \
                       (long long)SpinSystem[BondNORecord[BondNumberIndex+4]*3+1]==(long long)SpinSystem[BondNORecord[BondNumberIndex+3]*3+1]*(-1) and \
                       (long long)SpinSystem[BondNORecord[BondNumberIndex+6]*3+1]==(long long)SpinSystem[BondNORecord[BondNumberIndex+5]*3+1]*(-1))
                       {
                           Hoperator[LoopNumA]=BondNumber*16+2;//*16 bond碼編號
                           Hoperator[LoopNumA+1]=BondNORecord[BondNumberIndex+1];
                           Hoperator[LoopNumA+2]=BondNORecord[BondNumberIndex+2];
                    ...
                    else
                    {
                       ...
                       for(LoopNumB = 0; LoopNumB < 3 ; LoopNumB+=1 )
                       {
                         ...
                         {
                            if((long long)SpinSystem[BondNORecord[BondNumberIndex+LoopNumB*2+1]*3+1]!=(long long)SpinSystem[BondNORecord[BondNumberIndex+LoopNumB*2+2]*3+1]*(-1))
                            {
                                Check = 0;
                         ...
                         {
                            if((long long)SpinSystem[BondNORecord[BondNumberIndex+LoopNumB*2+1]*3+1]!=(long long)SpinSystem[BondNORecord[BondNumberIndex+LoopNumB*2+2]*3+1])
                            {
                                //printf("Ferro %.1f %.1f \n",SpinSystem[BondNORecord[BondNumberIndex+LoopNumB*2+1]*3+1],SpinSystem[BondNORecord[BondNumberIndex+LoopNumB*2+2]*3+1]);
                                Check = 0;
                                break;
        ...
        else//該Hoperator非空
        {
            ...
            switch(Hoperator[LoopNumA]&15)
            {
                ...
                case 14://Bond1 2 3 off 2+3+4+5
                    ...
                    break;
                default:
                    printf("Diagonal-Update %d  %d \n",Hoperator[LoopNumA],Hoperator[LoopNumA]&15);
                    system("pause");
...
void DiaUpdateJQ3_Spin1_test(double* SpinSystem,double* BondNOsystem,long long* Hoperator\
          ,double &Beta,long long &HNO,long long &Size,long long &SpinNO,long long &BondNO,long long &HoperatorNO,long long* BondNORecord)
{
//最後一Spin為Ferromagnetic    
   long long LoopNumA,LoopNumB,LoopNumC;
   ...
   for(LoopNumA=0;LoopNumA <HoperatorNO*7;LoopNumA=LoopNumA+7)
    {
        //printf("LoopNumA=%d HoperatorNO=%d \n",LoopNumA,HoperatorNO*7);
        //printf("%d test DiaUpdateJQ3-a\n",LoopNumA);
        if(Hoperator[LoopNumA]==-2)//該Hoperator 為空 測試用-2不會成立就不會執行
        {
            ...
            {
                //printf("HoperatorNO-HNO=%d  %f\n",HoperatorNO-HNO, (double)((BondNO)*(BondNOsystem[BondNumber*2+1]*Beta*0.125)));
                if(genrand64_real2()*(double)(HoperatorNO-HNO)==-2 )//測試用 小於-1不會成立不會執行
        ...
        else//該Hoperator非空
        {
            ...
            {
                case 0:
                    //if(genrand64_real2()*((double)((BondNO)*(BondNOsystem[(long long)(Hoperator[LoopNumA]>>4)*2+1]*Beta*0.5)))<(double)(HoperatorNO-HNO+1))
                    if(genrand64_real2()*((double)((BondNO)*(BondNOsystem[(long long)(Hoperator[LoopNumA]>>4)*2+1]*Beta*0.5)))==-2)
                    {
                        Hoperator[LoopNumA]=-1;
                        Hoperator[LoopNumA+1]=-1;
                        Hoperator[LoopNumA+2]=-1;
                ...
                case 1:
                    ...
                    */
                    break;
                case 2:
                    //if(genrand64_real2()*((double)((BondNO)*(BondNOsystem[(long long)((Hoperator[LoopNumA]-2)>>4)*2+1]*Beta*0.125)))<(double)(HoperatorNO-HNO+1))
                    if(genrand64_real2()*((double)((BondNO)*(BondNOsystem[(long long)((Hoperator[LoopNumA]-2)>>4)*2+1]*Beta*0.125)))==-2)
                    {
                        Hoperator[LoopNumA]=-1;
                        Hoperator[LoopNumA+1]=-1;
                        Hoperator[LoopNumA+2]=-1;
