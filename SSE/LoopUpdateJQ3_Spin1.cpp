void LoopUpdateJQ3_Spin1_TempW(long long* SpinSystem,double* BondNOsystem,\
...
void LoopUpdateJQ3_Spin1(long long* SpinSystem,double* BondNOsystem,\
                    long long* Hoperator,long long &HNO,\
                    long long &SpinNO,long long &BondNO,long long &HoperatorNO,\
                    double &TempW,long long* BondNORecord)
{
        ...
        */
        ...
        if(Hop!=-1)
        {
            ...
            if (BondNORecord[((long long)(Hop>>4))*7]>-1)
            {
                ...
                {
                    //((long long)(Hop>>4))*7]-1) Ferromagnetic Bond的位置
                    HSpinLR[(BondNORecord[((long long)(Hop>>4))*7]-1)*4]= BondNORecord[((long long)(Hop>>4))*7];
                    HSpinLR[(BondNORecord[((long long)(Hop>>4))*7]-1)*4+2]= BondNORecord[((long long)(Hop>>4))*7];
                    //printf("Q Bond %d , %d \n", HSpinLR[(BondNORecord[((long long)(Hop>>4))*7]-1)*2],HSpinLR[(BondNORecord[((long long)(Hop>>4))*7]-1)*2+2]);
                }
    ...
    */   
    /*
    for(LoopNumA=0;LoopNumA <HoperatorNO*12;LoopNumA=LoopNumA+1)
    {
        //printf("%2d ,H=%3d  ,L=%3d  ,R=%3d \n",LoopNumA/3, Hoperator[LoopNumA], Hoperator[LoopNumA+1], Hoperator[LoopNumA+2]);
        for(LoopNumB=0;LoopNumB <12;LoopNumB+=1)
        {
            if(SpinRecord[LoopNumA*2+LoopNumB*2+1]>-1 )
            {
