...
#include "SSE/DiaUpdateJQ3_Honeycomb_SpinHalf.cpp"
...
int main(int argc, char *argv[])
{
    ...
    double *BondNOsystem,RdSpin;
    double LoopJ,LoopBeta,Beta,J,StrongJ,Probability,Q,StrongQ;
    long long *SpinSystem,*Hoperator,*BondNORecord;
    //測量變數
    double AFM,AFM1,AFM2,AFM4,AFM6,AX1,AFM1abs,Measure,MeansMeasure,Means,STD,STDD,WiddingX,WiddingY,WiddingZ,TempW;
    double *UsuscMent,*AFMMent,*AFM1Ment,*AFM2Ment,*AFM4Ment,*AFM6Ment,*AX1Ment,*AFM1absMent,\
    *WindingXMent,*WindingYMent,*WindingZMent,*TempWMent,*HNOMent;//,*Widding;
    ...
    TempWMeans,TempWSTD,TempWErr,HNOMeasure;
    ...
    else
    {
        switch(Type)
        {
            case 30:
                ...
                break;
            case 31:
                BondNO=(long long)SpinNO*2.5;
                BondNORecord=(long long *)malloc((BondNO*6+1)*sizeof(long long*));
                memset(BondNORecord,-1,(BondNO*6+1)*sizeof(long long*)); 
                break;
            case 32:
                BondNO=(long long)((SpinNO+1)*2.5)-9;
                BondNORecord=(long long *)malloc((BondNO*6+1)*sizeof(long long*));
                memset(BondNORecord,-1,(BondNO*6+1)*sizeof(long long*)); 
                break;           
    ...
    AFM1absMent=(double *)malloc((MeasureT/MeasureStep+1)*sizeof(double*));
    ...
    HNOMent=(double *)malloc((MeasureT/MeasureStep+1)*sizeof(double*));
    ...
    SpinSystem=(long long *)malloc((SpinSystemSize+1)*sizeof(long long*));
    ...
    */
    ...
    MakeLattice_Honeycomb_JQ3_SpinHalf(Type,SpinSystem,BondNOsystem,Hoperator,Size,SpinNO,BondNO,HoperatorNO,J,StrongJ,Q,StrongQ,Probability,BondNORecord,XSize,YSize);
    /*
    ...
    */
    ...
    for(LoopNumA=0;LoopNumA<T;LoopNumA+=1)
    {   
        //printf("Diagonal-update Begain %d test0\n",LoopNumA);
        DiaUpdateJQ3_Honeycomb_SpinHalf(SpinSystem,BondNOsystem,Hoperator,Beta,HNO,XSize,SpinNO,BondNO,HoperatorNO,BondNORecord,XSize,YSize);
        /*
        ...
        {   
            ...
            printf("   %6d ,H=   %3d   (%3d)  ,L=%3d  ,R=%3d ,L2=%3d  ,R2=%3d ,L3=%3d  ,R3=%3d\n",(long long)LoopNumB/7, Hoperator[LoopNumB],(long long)(Hoperator[LoopNumB]>>4)\
    ...
    */
    ...
    sprintf(FileNameDetail,"JQ3Honeycomb-SpinHalf-Lx%dLy%d-Beta%.2lf-Q%.4lf-Seed%5ld-%d.txt",XSize,YSize,Beta,Q,SeedNum,atoi(argv[11]));//FileNameDetailData
    ...
    for(LoopNumA=0;LoopNumA<(long long)(MeasureT/MeasureStep);LoopNumA++)
    {
        ...
        {
            //printf("%d test4\n",LoopNumA);
            DiaUpdateJQ3_Honeycomb_SpinHalf(SpinSystem,BondNOsystem,Hoperator,Beta,HNO,Size,SpinNO,BondNO,HoperatorNO,BondNORecord,XSize,YSize);
            //printf("%d test5\n",LoopNumA);
            LoopUpdateJQ3_TempW(SpinSystem,BondNOsystem,Hoperator,HNO,SpinNO,BondNO,HoperatorNO,TempW,BondNORecord);
            //printf("%d test6\n",LoopNumA);
            MeasureFuctJQ3_Honeycomb_SpinHalf(SpinSystem, BondNOsystem, Hoperator,HNO,Size,SpinNO,BondNO,HoperatorNO\
                        ,AFM,AFM1,AFM2,AFM4,AFM6,AX1,AFM1abs,Measure,WiddingX,WiddingY,WiddingZ,HNOMeasure,BondNORecord);
        ...
        //printf("%d \n",LoopNumA);
        MeasureMeans_Honeycomb(AFM,AFM1,AFM2,AFM4,AFM6,AX1,AFM1abs,Measure,WiddingX,WiddingY,WiddingZ,HNOMeasure,TempW,XSize,YSize,Beta,MeasureStep,SpinNO\
        ,UsuscMent[LoopNumA],AFM1Ment[LoopNumA],AFM2Ment[LoopNumA],AFM4Ment[LoopNumA]\
        ,AFM6Ment[LoopNumA],AX1Ment[LoopNumA],AFM1absMent[LoopNumA],WindingXMent[LoopNumA],WindingYMent[LoopNumA],HNOMent[LoopNumA],TempWMent[LoopNumA]);
        //printf("aaa%f \n",TempW); 
        FileDetail=fopen(FileNameDetail, "a+");
        fprintf(FileDetail,"%2d   %2d   %2.16lf    %2.16lf   %2.16lf   %2.16lf    ",XSize,YSize,Beta,J,Q,HNOMent[LoopNumA]);
        fprintf(FileDetail,"%2.16lf    %2.16lf    %2.16lf    %2.16lf    %2.16lf    %2.16lf    %2.16lf    %2.16lf    %2.16lf     %2.16lf\n",\
        UsuscMent[LoopNumA],\
        AFM1Ment[LoopNumA], \
        AFM2Ment[LoopNumA], \
        AFM4Ment[LoopNumA],  \
    ...
    fprintf(FileTime,"JQ3Honeycomb-SpinHalf-Lx%dLy%d-Beta%.2lf-Q%.4lf-Seed%ld-%d",XSize,YSize,Beta,Q,SeedNum,atoi(argv[11]));
    fprintf(FileTime,"  %lf sec.\n",(double)(EndTime-StartTime)/CLOCKS_PER_SEC);
    fclose(FileTime);
    /*
